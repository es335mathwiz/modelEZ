/* Generated By:JavaCC: Do not edit this line. AMAtoMatlab.java */
package gov.frb.ma.msu.toMatlab;
import gov.frb.ma.msu.modelEZCommon.*;
import java.io.*;

public class AMAtoMatlab implements AMAtoMatlabConstants {
...
//      System.err.println("No semantic errors found.");
    if (ErrorCount != 0)
 {
  ...
  static public AMAtoMatlabTokenManager token_source;
  ...
  public AMAtoMatlab(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public AMAtoMatlab(java.io.InputStream stream, String encoding) {
    ...
    token_source = new AMAtoMatlabTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public AMAtoMatlab(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public AMAtoMatlab(AMAtoMatlabTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(AMAtoMatlabTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
