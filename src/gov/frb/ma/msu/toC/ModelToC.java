...
public class ModelToC extends Model {
	...
	******************************************************************/
	    ...
	    matrixPS.println("int parserwrapper_(double *params,double *g, double *h,double*hmat,int *HROWS,int *HCOLS)");
	    matrixPS.println("{");
	    
	    matrixPS.println(lcName + "_AMA_matrices(params,g,h);");
