#!/bin/bash
parserJarLoc= /msu/home/m1wlg01/economistprojects/anderson/simpleSparseAMAExample/willschrissparseama/garysparseAMA/modelEZ/modelEZtoC.jar
javaCmd=java
CC=gcc
